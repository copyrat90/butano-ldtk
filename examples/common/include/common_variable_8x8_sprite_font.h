...
constexpr bn::utf8_character variable_8x8_sprite_font_utf8_characters[] = {"Á", "É", "Í", "Ó", "Ú", "Ü", "Ñ", "á",
                                                                           "é", "í", "ó", "ú", "ü", "ñ", "¡", "¿"};
...
constexpr bn::sprite_font variable_8x8_sprite_font(bn::sprite_items::common_variable_8x8_font,
